...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=11, default=9999999999)
...
class Food(models.Model):
    ...
    description = models.CharField(max_length=555,default="Description about Food")

    class Meta:
        db_table = 'Food'

class CartItems(models.Model):
    meal = models.ForeignKey(Food, on_delete=models.CASCADE, null=True)
...
class OrderItem(models.Model):
    meal = models.ForeignKey(Food, on_delete=models.SET_NULL, null=True)
